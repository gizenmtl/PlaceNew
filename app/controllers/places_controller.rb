class PlacesController < ApplicationController
	...
	def create
		@place = current_customer.placess.new(place_params)

			if @place.save
				flash[:success] = 'Rezervasyonunuz basariyla tamamlandi'
	...
	def authorize_customer!
    	redirect_to root_path, notice: "Not authorized" unless @place.customer_id == current_customer.id
    end
	...
	#paramsın önüne strong ya da place yazmak fark etmez.
